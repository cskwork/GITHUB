...
from utils.helpers import RandomFileName, unique_slug_generator
...
class BlogPost(models.Model):
	...
	image 				= models.ImageField(upload_to=RandomFileName('blogImage'), blank=True)
...
def pre_save_blog_post_receiever(sender, instance, *args, **kwargs):
	if not instance.slug:
		instance.slug = unique_slug_generator(instance, instance.title, instance.author, instance.slug) 
